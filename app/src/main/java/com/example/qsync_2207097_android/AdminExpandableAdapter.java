...
public class AdminExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public AdminExpandableAdapter(Context context, List<Department> departments,
                                 HashMap<String, List<Doctor>> departmentDoctors,
                                 HashMap<String, List<AdminQueueItem>> doctorQueues) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        int queueSize = queues != null ? queues.size() : 0;
        android.util.Log.d("AdminExpandableAdapter", "Doctor " + doctor.id + " queues=" + queueSize);
    ...
    private View createQueueItemView(AdminQueueItem queueItem, ViewGroup parent) {
        ...
        if (tokenNumber != null) {
            String token = queueItem.tokenNumber != null && !queueItem.tokenNumber.isEmpty()
                ? queueItem.tokenNumber
                : "T" + String.format("%03d", queueItem.position);
        ...
        if (patientName != null) {
            String name = queueItem.patientName != null && !queueItem.patientName.isEmpty()
